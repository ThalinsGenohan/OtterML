#include <OtterML/Graphics/Texture2D.hpp>
...
{
	this->Generate(Vector2<u32>(width, height), data);
}

void Texture2D::Generate(const Vector2<u32>& size, const u8* data)
{
	this->_size = size;
...
const Vector2<u32>& Texture2D::GetTextureSize() const
{
	return this->_size;
}

const Vector2<u32>& Texture2D::GetFrameSize() const
{
	return this->_frameSize;
}

void Texture2D::SetFrameSize(const Vector2<u32>& frameSize)
{
